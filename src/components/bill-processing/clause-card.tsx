...
import { ThumbsUp, ThumbsDown, BrainCircuit, Loader2 } from 'lucide-react';
        ...
        <AccordionTrigger className="p-6 hover:no-underline">
          <div className="flex w-full flex-row items-start justify-between space-x-4 text-left">
            ...
            <div className="flex items-center space-x-2">
                ...
                <ThumbsDown className={cn("h-5 w-5", voteStatus === 'rejected' ? 'text-red-600' : 'text-muted-foreground/50')} />
            </div>
          </div>
        </AccordionTrigger>
        <AccordionContent>
          <div className="px-6 pb-6 space-y-4">
            ...
            <div className="border-t pt-4">
              ...
              {explanation && (
                <div className="border-t bg-muted/50 p-4 rounded-md mt-4">
